import { ActionCardHash, ActionCardYamlData, ActionCardName } from "../../../Client/src/Share/Yaml/actionCardYamlData";
...
export class ActionCardStacks {
    ...
    settingCard() {
        ...
        const actionCardHash: ActionCardHash = GenerateActionCardYamlData(yamlGet("./Client/public/Resource/Yaml/actionCard.yaml"), false);
