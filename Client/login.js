...
/***/ (function (module, exports, __webpack_require__) {
      ...
      socket.on("addMember", (data) => {
        ...
        if (member != null)
          addMember(member.roomID, member.playerName, member.playerTag);
      });
      socket.on("deleteMember", (data) => {
        let member = JSON.parse(data);
        if (member != null)
          deleteMember(member.roomID, member.playerTag);
      });
      socket.on("updatePlayFlag", (data) => {
...
/* WEBPACK VAR INJECTION */(function (module, global) {
        ...
        /* WEBPACK VAR INJECTION */
}.call(exports, __webpack_require__(38)(module), __webpack_require__(0)))
